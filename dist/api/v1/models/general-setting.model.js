...
const generalSettingSchema = new mongoose_1.Schema({
    gsLogo: { type: String },
...
const GeneralSettingModel = mongoose_1.default.model("GeneralSetting", generalSettingSchema, "general-settings");
