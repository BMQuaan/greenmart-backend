...
const order_validation_1 = require("../../validations/client/order.validation");
const router = express_1.default.Router();
router.post("/", (0, validateRequest_1.default)(order_validation_1.createOrderSchema), controller.createOrder);
