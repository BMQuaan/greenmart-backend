...
const auth_validation_1 = require("../../validations/admin/auth.validation");
...
router.put("/update", authMiddleware.authenticateStaffToken, upload.single("staffAvatar"), (0, validateRequest_1.default)(auth_validation_1.updateOwnProfileSchema), controller.update);
